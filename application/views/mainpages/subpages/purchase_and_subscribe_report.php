        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-lg-offset-3 col-md-offset-3 col-sm-offset-3">
                <div class="text-center feature-head">
                    <h1>STEPS OF ACQUIRING A REPORT</h1>
                </div>
            </div>
            <div class="col-lg-11  col-md-11  col-sm-11 col-xs-11  col-lg-offset-1 col-md-offset-1 col-sm-offset-1">
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <center>
                        <div class="stepy-titles ">
                            <center><b><h4 id="step-number">Step 1</h4></b>
                                <p>
                                    <i class="fa fa-search" id="fa-icon-size"></i>
                                    <br/> Identify a report from reports section.
                                </p>
                            </center>
                        </div>
                    </center>
                ...
                <!-- div for arrow -->
                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12 arrow_box">
                </div>
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <center>
                        <div class="stepy-titles">
                            <center><b><h4 id="step-number">Step 2</h4></b>
                                <p>
                                    <i class="fa fa-eye" id="fa-icon-size"></i>
                                    <br/> View Sample of the Report
                                </p>
                            </center>
                        </div>
                    </center>
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <center>
                        <div class="stepy-titles">
                            <center>
                                <b><h4 id="step-number" >Step 3</h4></b>
                                <p>
                                    <span class="fa fa-money" id="fa-icon-size"></span>
                                    <br/> <h5>Purchase by Subscription <br/>or Direct Purchase</h5>
                                </p>
                            </center>
                        </div>
                    </center>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mtop20 ">
                <a href="<?=base_url()?>welcome/industry" type="button" class="col-lg-4 col-md-4 col-sm-4 col-lg-offset-4 col-md-offset-4 col-sm-offset-4 col-xs-12 btn btn-info btn-lg btn btn-shadow caption lft slide_btn red"><span class="fa fa-arrow-circle-right"></span>Start Purchase</a>
            </div>
        </div>
        <!-- /end row -->
            ...
            <div class="quote">
                <div class="col-lg-12 col-sm-12">
                    <div class="quote-info">
                        <h1>Our Packages</h1>
                        <p><span><b>The following are the packages we offer. Download the forms per given package, after reading and agreeing to our terms and conditions, fill in the details and send it to us to initiate the process of subscription....</b></span></p>
                    </div>
                </div>
               <!--  <div class="col-lg-2 col-sm-2">
                    <a href="#" class="btn btn-danger purchase-btn">Terms & Conditions</a>
                </div> -->
            </div>
            <!--quote end-->
        </div>
        <!--/ end row for or button -->
...
including any obligation to make any payment.
      ...
      <div class="modal-footer">
       ...
       <!--  <a href="<?= base_url()?>assets/application_form/<?= $homepage_data['packages'][2]['application_form']; ?>" target='_blank' id="myLink" class='btn btn-primary btn-shadow'><i class="fa fa-cloud-download" data-toggle="modal" data-target="#myModal" disabled></i>Download Application Form</a> -->
        ...
        <form method="link" id="form3"  action="<?= base_url()?>assets/application_form/<?= $homepage_data['packages'][2]['application_form']; ?>" >
