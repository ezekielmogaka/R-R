var App = function() {
    ...
    var handleDataTables = function() {
            ...
            $('#datatable2').dataTable({
                ...
                oTableTools: {
                    ...
                    sSwfPath: "../../assets/admin_assets/js/datatables/extras/TableTools/media/swf/copy_csv_xls_pdf.swf"
                }
            });
    ...
    var handleBackstretch = function() {
            $.backstretch([
                "img/login/1.jpg", "img/login/2.jpg", "img/login/3.jpg", "img/login/4.jpg"
    ...
    var handleGritter = function() {
            ...
            setTimeout(function() {
                var unique_id = $.gritter.add({
                    ...
                    title: 'Welcome Market Sectors Admin',
                    // (string | mandatory) the text inside the notification
                    text: 'Market Sectors Kenya',
                    // (string | optional) the image to display on the left
                    image: '../../assets/admin_assets/img/gritter/cloud.png',
            ...
            setTimeout(function() {
                var unique_id = $.gritter.add({
                    ...
                    text: 'Market Sectors Kenya',
                    // (string | optional) the image to display on the left
                    image: '../../assets/admin_assets/img/gritter/settings.png',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
                    // (int | optional) the time you want it to be alive for before fading out
                    time: '',
            ...
            setTimeout(function() {
                ...
                var unique_id = $.gritter.add({
                    position: 'top-left',
                    // (string | mandatory) the heading of the notification
                    title: 'The best provider of Industry,Sector and Corporate Reports',
                    // (string | mandatory) the text inside the notification
                    text: 'Market Sectors Admin',
                    // (string | optional) the image to display on the left
                    image: '../../assets/admin_assets/img/gritter/buy.png',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
                    // (int | optional) the time you want it to be alive for before fading out
                    time: '',
    ...
    return {
        ...
        blockUI: function(el, loaderOnTop) {
            lastBlockedUI = el;
            jQuery(el).block({
                message: '<img src="../../assets/admin_assets/img/loaders/12.gif" align="absmiddle">',
                css: {
                    border: 'none',
                    padding: '2px',
